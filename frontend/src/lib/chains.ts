...
export const IRIS_API_URL =
  import.meta.env.VITE_IRIS_API_URL ?? "https://iris-api-sandbox.circle.com";

// RPC URLs for supported chains
export const CHAIN_RPC_URLS: Record<number, string> = {
  [SupportedChainId.ETH_SEPOLIA]: "https://eth-sepolia.g.alchemy.com/v2/NMsHzNgJ7XUYtzNyFpEJ8yT4muQ_lkRF",
  [SupportedChainId.AVAX_FUJI]: "https://avax-fuji.g.alchemy.com/v2/NMsHzNgJ7XUYtzNyFpEJ8yT4muQ_lkRF",
  [SupportedChainId.BASE_SEPOLIA]: "https://base-sepolia.g.alchemy.com/v2/NMsHzNgJ7XUYtzNyFpEJ8yT4muQ_lkRF",
  [SupportedChainId.ARBITRUM_SEPOLIA]: "https://arb-sepolia.g.alchemy.com/v2/NMsHzNgJ7XUYtzNyFpEJ8yT4muQ_lkRF",
  [SupportedChainId.OPTIMISM_SEPOLIA]: "https://opt-sepolia.g.alchemy.com/v2/NMsHzNgJ7XUYtzNyFpEJ8yT4muQ_lkRF",
  [SupportedChainId.LINEA_SEPOLIA]: "https://linea-sepolia.infura.io/v3/9aa3d95b3bc440fa88ea12eaa4456161",
  [SupportedChainId.POLYGON_AMOY]: "https://polygon-amoy.infura.io/v3/9aa3d95b3bc440fa88ea12eaa4456161",
  [SupportedChainId.WORLDCHAIN_SEPOLIA]: "https://sepolia.worldcoin.org",
  [SupportedChainId.SONIC_BLAZE]: "https://rpc.sonic.game",
  [SupportedChainId.CODEX_TESTNET]: "https://812242.rpc.thirdweb.com",
  [SupportedChainId.UNICHAIN_SEPOLIA]: "https://rpc-testnet.uni.team",
  [SupportedChainId.SEI_TESTNET]: "https://rpc-testnet.sei.io",
};
